const FAQ =()  => {
  return (
    <>
    <div className="space-y-4 px-20 mt-10" id="faq">
      <h2 className="text-3xl font-bold sm:text-4xl text-left mb-6">
        Frequently Asked Questions About Webonism
      </h2>
      <details
        className="group border-s-4 border-orange-600  p-6 [&_summary::-webkit-details-marker]:hidden"
        open
      >
        <summary className="flex cursor-pointer items-center justify-between gap-1.5">
          <h2 className="text-md font-medium text-gray-900">
          What services does Webonism offer?
          </h2>
        ...
        We provide comprehensive web design and development services, including custom website creation, e-commerce solutions, SEO optimization, and website maintenance.


        </p>
      </details>

      <details className="group border-s-4 border-orange-600  p-6 [&_summary::-webkit-details-marker]:hidden">
        <summary className="flex cursor-pointer items-center justify-between gap-1.5">
          <h2 className="text-md font-medium text-gray-900">
      ...
      <details className="group border-s-4 border-orange-600  p-6 [&_summary::-webkit-details-marker]:hidden">
        ...
        <p className="mt-4 leading-relaxed text-gray-700 text-left">
        Absolutely! Our team specializes in SEO strategies, content optimization, and digital marketing to improve your site’s visibility and help you reach your target audience.
        </p>
      </details>
      <details className="group border-s-4 border-orange-600  p-6 [&_summary::-webkit-details-marker]:hidden">
        <summary className="flex cursor-pointer items-center justify-between gap-1.5">
